...
class ScrollableImage(tk.Frame):
    def __init__(self, master=None, **kw):
        ...
        #self.cnvs.bind("<ButtonPress-1>", self.printcoord)
...
class StatusColumn(tk.Frame):
    def __init__(self, master=None, **kw):
        ...
        self.x_coord = tk.Label(self.coordinate, textvariable=self.x_coord_var, cursor='xterm')
        self.x_coord.grid(row=0, column=0, sticky='nw')
        self.y_coord_var = tk.StringVar()
        self.y_coord_var.set("y: 0")
        self.y_coord = tk.Label(self.coordinate, textvariable=self.y_coord_var, cursor='xterm')
        ...
        self.R = tk.Label(self.RGB, textvariable=self.R_var, cursor='xterm')
        self.R.grid(row=0, column=0, sticky='nw')
        self.G_var = tk.StringVar()
        self.G_var.set("G: None")
        self.G = tk.Label(self.RGB, textvariable=self.G_var, cursor='xterm')
        self.G.grid(row=1, column=0, sticky='nw')
        self.B_var = tk.StringVar()
        self.B_var.set("B: None")
        self.B = tk.Label(self.RGB, textvariable=self.B_var, cursor='xterm')
        ...
        self.X = tk.Label(self.XYZ, textvariable=self.X_var, cursor='xterm')
        self.X.grid(row=0, column=0, sticky='nw')
        self.Y_var = tk.StringVar()
        self.Y_var.set("Y: None")
        self.Y = tk.Label(self.XYZ, textvariable=self.Y_var, cursor='xterm')
        self.Y.grid(row=1, column=0, sticky='nw')
        self.Z_var = tk.StringVar()
        self.Z_var.set("Z: None")
        self.Z = tk.Label(self.XYZ, textvariable=self.Z_var, cursor='xterm')
